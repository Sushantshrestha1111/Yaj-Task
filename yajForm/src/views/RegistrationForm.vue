<template>
  ...
  <span class="absolute inset-y-0 right-3 flex text-[#444444] items-center pointer-events-none">
    <img :src="down" alt="">
        ...
        <!--  office Addresss-->
        <span class="text-[#777777] mb-[8px] font-normal">Office Address:</span>
  ...
  <div class="flex flex-col flex-1 gap-x-4">
    ...
    <div class="relative w-full">
      ...
      >
        ...
        <option v-for="option in district" :key="option.value" :value="option.value">
          {{ option.label }}
        </option>
      </select>
      <!-- Custom arrow -->
  ...
  <div class="flex flex-col flex-1 gap-x-4">
    ...
    <div class="relative w-full">
      ...
      >
        <option class="text-black" disabled value="">Select Municipality</option>
        <option v-for="option in options" :key="option.value" :value="option.value">
          {{ option.label }}
        </option>
      </select>
...
<Label class="mb-[12px]" for="ComplaintServivity">Complaint Servicity <span class="text-red-500">*</span></Label>


<div>
  
  <div class="flex flex-row mb-[24px] gap-x-6 w-full">
    <!-- Common -->
      ...
      <label for="r3" class="font-[16px] text-[#444444] ">Very Important</label>
        ...
        <div class="flex items-end justify-end">
          <RouterLink to="/secondform">
            <Button class="bg-blue-500 h-10 p-2 rounded-md text-white">Procede to next page</Button>
